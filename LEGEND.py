...
CHANNEL_ID = -6496337480
error_channel_id = -6496337480
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="🔥 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 🔥", url="https://t.me/VIKKI_OWNER")
    button1 = types.InlineKeyboardButton(text="👤 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 👤",
        url="https://t.me/VIKKI_OWNER")
    markup.add(button3)
    markup.add(button1)
    return markup
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Contact the owner for assistance: @ROYxOWNER.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 WELCOME TO VIKKI BHAI DDOS WORLD!* 🎉\n\n"
